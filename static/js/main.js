...
$(document).on('submit', '#signupForm', function(event){
	...
	$('.button-group .menu-block').html('<div class="loader"></div>');
	$('.button-group .menu-block').prop('disabled', true);
...
$(document).on('submit', '#confirmResetForm', function(event){
	...
	var input_data = {
		...
		'uid':custom_url.substring(23, 25),
		'token':custom_url.substring(26, 65),
	}
